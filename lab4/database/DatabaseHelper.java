...
{
    public static void
    insert(org.omg.CORBA.Any any, Database val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_interface_tc(id(), "Database");
        }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        _DatabaseStub _ob_stub = new _DatabaseStub();
        _ob_stub._set_delegate(_ob_impl._get_delegate());
        return _ob_stub;
    }

    public static void
    write(org.omg.CORBA.portable.OutputStream out, Database val)
    {
