...
//
final public class token_typeHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_alias_tc(id(), "token_type", orb.create_sequence_tc(0, orb.get_primitive_tc(org.omg.CORBA.TCKind.tk_long)));
        }
    ...
    id()
    {
        return "IDL:Lock/token_type:1.0";
    }
